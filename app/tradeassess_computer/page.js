                ...
                <center>
                  <table border={1} cellSpacing={0}>
                   ...
                   <Ttitle/>
                    ...
                    <PrintingRow criteria="5.Understand messages in dialog  box, act upon them. " totalMark={6} marksCount={2} marks1Count={4} no={1} setSums={setSums}/>
                    <PrintingRow criteria="6.Request for support on errors during start, login " totalMark={6} marksCount={2} marks1Count={4} no={1} setSums={setSums}/>
                    <PrintingRow criteria="7.Know, Connect and operate Assistive devices / peripherals. " totalMark={6} marksCount={2} marks1Count={4} no={1} setSums={setSums}/>
                    ...
                    <PrintingRow criteria="2.Refer to Calendar for dates / day / find future dates or Change date / time" totalMark={6} marksCount={2} marks1Count={4}  no={3} setSums={setSums}/>
                    <PrintingRow criteria="3.Search Applications by Desktop Icons / execute or typing first few letters and executee" totalMark={6} marksCount={2} marks1Count={4} no={3} setSums={setSums}/>
                    <PrintingRow criteria="4.Open and Close application" totalMark={6} marksCount={2} marks1Count={4} no={3} setSums={setSums} />
                    <PrintingRow criteria="5.Know basic elements of Window (Title Bar, Menu Bar, Context Menu, Work Area)" totalMark={6} marksCount={2} marks1Count={4} no={3} setSums={setSums} />
                    <PrintingRow criteria="6.Navigate through various elements like Menu, Submenu" totalMark={6} marksCount={2} marks1Count={4} no={3} setSums={setSums} />
                    <PrintingRow criteria="7.Know Windows Explorer / Operate on My Computer / Drives (Hard Disks and other Storage devices)" totalMark={6} marksCount={2} marks1Count={4} no={3} setSums={setSums} />
                    <PrintingRow criteria="8.Know organisation of Data as File / Folder" totalMark={4} marksCount={1} marks1Count={3} no={3} setSums={setSums} />
                    ...
                    <PrintingRow criteria="22.Navigate between multiple Active programs / Desktop" totalMark={3} marksCount={1} marks1Count={2} no={3} setSums={setSums} />
                    <PrintingRow criteria="23.Use Calculator application for basic addition, subtraction, multiplication and division" totalMark={3} marksCount={1} marks1Count={2} no={3} setSums={setSums} />    

                    <TotalRow outOf={100} totalMarks={100} ti={3} sums={sums} theory={30} practical={70}/>
                    <PrintingTableRow outcome="4.Self and Work Management" crieteria="1.Establish relationship with the fellow team members, supervisors and understand the work requirements" outof={50} totalMarks={7} rowspan={8} marksCount={2} marks1Count={5} no={4} setSums={setSums} />
                    <PrintingRow criteria="2.Keep immediate work area clean and tidy" totalMark={7} marksCount={2} marks1Count={5} no={4} setSums={setSums} />
                    <PrintingRow criteria="3.Utilize time effectively" totalMark={7} marksCount={2} marks1Count={5} no={4} setSums={setSums} />
                    <PrintingRow criteria="4. User sources efficiently" totalMark={6} marksCount={2} marks1Count={4} no={4} setSums={setSums} />
                    <PrintingRow criteria="5.Work in line with organization’s policies and procedures under guidance." totalMark={6} marksCount={2} marks1Count={4} no={4} setSums={setSums} />
                    <PrintingRow criteria="6.Work within the limits of job role." totalMark={6} marksCount={2} marks1Count={4} no={4} setSums={setSums} />
                    <PrintingRow criteria="7.Obtain guidance from appropriate people, where necessary." totalMark={6} marksCount={2} marks1Count={4} no={4} setSums={setSums} />
                    <PrintingRow criteria="8.Ensure work meet the agreed requirements." totalMark={5} marksCount={1} marks1Count={4} no={4} setSums={setSums} />
