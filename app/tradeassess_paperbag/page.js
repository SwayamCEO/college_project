                ...
                <center>
                  <table border={1} cellSpacing={0}>
                   ...
                   <Ttitle/>
                    ...
                    <PrintingTableRow outcome="1.Paper Bag Making Activity procedure" crieteria="1.Cleaning and arranging the work place Arranging the materials in work place" outof={100} totalMarks={10} rowspan={13} marksCount={3} marks1Count={7} no={1} setSums={setSums}/>
                    <PrintingRow criteria="2.Identifying and naming the materials" totalMark={10} marksCount={3} marks1Count={7} no={1} setSums={setSums}/>
                    <PrintingRow criteria="3.Take the hand made paper Fold 2” inside from top of the paper" totalMark={4} marksCount={2} marks1Count={2} no={1} setSums={setSums} />
                    <PrintingRow criteria="4.Join the two sides ends with fevicol" totalMark={4} marksCount={2} marks1Count={2} no={1} setSums={setSums}/>
                    <PrintingRow criteria="5.Squeeze the sides with device." totalMark={4} marksCount={2} marks1Count={2} no={1} setSums={setSums}/>
                    <PrintingRow criteria="6.Folding the bottom side and two opposite sides" totalMark={4} marksCount={2} marks1Count={2} no={1} setSums={setSums}/>
                    <PrintingRow criteria="7.Folding the another two opposite sides. " totalMark={4} marksCount={2} marks1Count={2} no={1} setSums={setSums}/>
                    <PrintingRow criteria="8.Apply gum and paste the opposite side. " totalMark={10} marksCount={3} marks1Count={7} no={1} setSums={setSums}/>
                    <PrintingRow criteria="9.Mark and punch holes for fixing handles" totalMark={10} marksCount={3} marks1Count={7} no={1} setSums={setSums}/>
                    <PrintingRow criteria="10.Fitting the eyelets" totalMark={10} marksCount={3} marks1Count={7} no={1} setSums={setSums}/>
                    <PrintingRow criteria="11.Insert thread into the eyelets. " totalMark={10} marksCount={3} marks1Count={7} no={1} setSums={setSums}/>
                    <PrintingRow criteria="12.Knot the  thread on two sides" totalMark={10} marksCount={3} marks1Count={7} no={1} setSums={setSums}/>
                    <PrintingRow criteria="13.Keeping the final product in a suitable place" totalMark={10} marksCount={3} marks1Count={7} no={1} setSums={setSums}/>
                    ...
                    <PrintingRow criteria="9.Minimize the waste" totalMark={10} marksCount={3} marks1Count={7} no={2} setSums={setSums}/>
                    <PrintingRow criteria="10.Work with team members" totalMark={10} marksCount={3} marks1Count={7} no={2} setSums={setSums}/>
                    <PrintingRow criteria="11.Seek clarifications from supervisors or other authorized personnel in case of perceived risks" totalMark={5} marksCount={2} marks1Count={3} no={2} setSums={setSums}/>
                    <PrintingRow criteria="12.Seek information regarding policies, and procedures from supervisor or other authorized personnel" totalMark={5} marksCount={2} marks1Count={3} no={2} setSums={setSums}/>
