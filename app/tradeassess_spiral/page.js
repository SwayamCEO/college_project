                ...
                <center>
                  <table border={1} cellSpacing={0}>
                   ...
                   <Ttitle/>
                    ...
                    <PrintingTableRow outcome="1.Spiral Binding" crieteria="1.Clean the spiral binding machine with clean cotton cloth." outof={100} totalMarks={10} rowspan={10} marksCount={3} marks1Count={7} no={1} setSums={setSums}/>
                    <PrintingRow criteria="2.Collect the  required material for spiral binding" totalMark={10} marksCount={3} marks1Count={7} no={1} setSums={setSums}/>
                    <PrintingRow criteria="3.Take 8-10 papers approximately from the spiral binding material" totalMark={10} marksCount={3} marks1Count={7} no={1} setSums={setSums}/>
                    <PrintingRow criteria="4.Keep papers inside the spiral binding  machine for punching" totalMark={10} marksCount={3} marks1Count={7} no={1} setSums={setSums}/>
                    <PrintingRow criteria="5.Move the  machine right handle down" totalMark={10} marksCount={3} marks1Count={7} no={1} setSums={setSums}/>
                    <PrintingRow criteria="6.Move the  machine right handle up" totalMark={10} marksCount={3} marks1Count={7} no={1} setSums={setSums}/>
                    <PrintingRow criteria="7.Remove papers from spiral binding machine" totalMark={10} marksCount={3} marks1Count={7} no={1} setSums={setSums}/>
                    <PrintingRow criteria="8.Keep papers uniformly" totalMark={10} marksCount={3} marks1Count={7} no={1} setSums={setSums}/>
                    <PrintingRow criteria="9.Again take 8-10 papers and set the papers correctly in the spiral binding machine do the activity  till material completed" totalMark={10} marksCount={3} marks1Count={7} no={1} setSums={setSums}/>
                    ...
                    <PrintingRow criteria="5.Select and cut the spiral wire size (more than size approximately)" totalMark={10} marksCount={3} marks1Count={7} no={2} setSums={setSums}/>
                    <PrintingRow criteria="6.Put the spiral wire in the first punching of the book binding material" totalMark={10} marksCount={3} marks1Count={7} no={2} setSums={setSums}/>
                    <PrintingRow criteria="7.Continue the binding work till last" totalMark={10} marksCount={3} marks1Count={7} no={2} setSums={setSums}/>
                    <PrintingRow criteria="8.Handing over the finished product" totalMark={10} marksCount={3} marks1Count={7} no={2} setSums={setSums}/>
                    <PrintingRow criteria="9.Asking for next task" totalMark={10} marksCount={3} marks1Count={7} no={2} setSums={setSums}/>
                    <PrintingRow criteria="10.Keep papers uniformly" totalMark={10} marksCount={3} marks1Count={7} no={2} setSums={setSums}/>
                    <TotalRow outOf={100} totalMarks={100} ti={2} sums={sums} theory={30} practical={70}/>

                    <PrintingTableRow outcome="3.Identify and names and uses of spiral binding required  material" outof={100} crieteria="1.Identify and names and uses of spiral binding required  material" totalMarks={10} rowspan={10} marksCount={3} marks1Count={7}  no={3} setSums={setSums}/>
                    <PrintingRow criteria="2.Punctuality in work place" totalMark={10} marksCount={3} marks1Count={7} no={3} setSums={setSums}/>
                    <PrintingRow criteria="3.Greet the supervisor and team members" totalMark={10} marksCount={3} marks1Count={7} no={3} setSums={setSums}/>
                    <PrintingRow criteria="4.Handle carefully materials when it uses" totalMark={10} marksCount={3} marks1Count={7} no={3} setSums={setSums}/>
                    <PrintingRow criteria="5.Reserves materials , equipments safety after use" totalMark={10} marksCount={3} marks1Count={7} no={3} setSums={setSums}/>
                    <PrintingRow criteria="6.Report to the responsible person when the work is disturbs" totalMark={10} marksCount={3} marks1Count={7} no={3} setSums={setSums}/>
                    <PrintingRow criteria="7.Minimize the waste" totalMark={10} marksCount={3} marks1Count={7} no={3} setSums={setSums}/>
                    <PrintingRow criteria="8.Seek clarifications from supervisors or other authorized personnel in case of perceived risks " totalMark={10} marksCount={3} marks1Count={7} no={3} setSums={setSums}/>
